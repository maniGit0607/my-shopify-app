...
/**
 * Get both current period and comparison period date ranges
 */
function getPeriodDateRanges(period) {
  const now = new Date();
  const today = new Date(now.getFullYear(), now.getMonth(), now.getDate());
  
  let currentStart, currentEnd, compStart, compEnd, compLabel;
  ...
  return {
    ...
    comparisonDateRange: formatDateRange(compStart, compEnd),
  };
}
        ...
        <InlineStack gap="300" blockAlign="end">
          <div style={{ width: '200px' }}>
            <div style={{ marginBottom: '4px' }}>
              <Text variant="bodySm">
                Period <span style={{ color: '#8c9196' }}>({getPeriodDateRanges(period).currentDateRange})</span>
              </Text>
            </div>
            <Select
              label="Period"
          ...
          <div style={{ width: '200px' }}>
            <div style={{ marginBottom: '4px' }}>
              <Text variant="bodySm">
                Compared to <span style={{ color: '#8c9196' }}>({getPeriodDateRanges(period).comparisonDateRange})</span>
              </Text>
            </div>
            <div
              style={{
